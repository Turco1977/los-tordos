...
export function ProyectosView({user,mob,onAddProject,onUpdProject,onDelProject,onAddTask,onUpdTask,onDelTask,onAddBudget,onUpdBudget,onDelBudget,onVoteProject,onRejectProject,onProjectMsg,filteredProjects}:any){

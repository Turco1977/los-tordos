  ...
  const sbContent=(<div style={{flex:1,overflowY:"auto" as const,padding:"8px 6px"}}>
    ...
    {onNav&&<div style={{marginTop:10,padding:"4px 2px"}}>
      ...
      {[
        ...
        {k:"hk-asist",l:"Asistencia Hockey",icon:"🏑",show:true},
        {k:"hk-partidos",l:"Partidos Hockey",icon:"🏑",show:true},
        {k:"hk-cal",l:"Calendario Hockey",icon:"📅",show:true},

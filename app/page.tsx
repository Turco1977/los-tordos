      ...
      <div style={{flex:1,display:"flex",flexDirection:"column" as const,minWidth:0}}>
        <div style={{background:headerBg,borderBottom:"1px solid "+colors.g2,padding:mob?"0 6px":"0 14px",display:"flex",justifyContent:"space-between",alignItems:"center",height:mob?52:48}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:mob?4:8,flexShrink:0}}>
            ...
            <button aria-label="Cerrar sesión" onClick={out} style={{width:mob?40:28,height:mob?40:28,borderRadius:7,border:"1px solid "+colors.g2,background:cardBg,cursor:"pointer",fontSize:mob?14:12,display:"flex",alignItems:"center",justifyContent:"center"}}>↩</button>
          </div>
        </div>

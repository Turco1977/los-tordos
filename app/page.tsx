      ...
      <div style={{flex:1,display:"flex",flexDirection:"column" as const,minWidth:0}}>
        <div style={{background:headerBg,borderBottom:"1px solid "+colors.g2,padding:mob?"0 8px":"0 14px",display:"flex",justifyContent:"space-between",alignItems:"center",height:48}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:mob?4:8,flexShrink:0}}>
            ...
            <button aria-label="Cambiar tema" onClick={toggleTheme} title={isDark?"Modo claro":"Modo oscuro"} style={{width:28,height:28,borderRadius:7,border:"1px solid "+colors.g2,background:cardBg,cursor:"pointer",fontSize:12}}>{isDark?"☀️":"🌙"}</button>
            <button aria-label="Cambiar contraseña" onClick={()=>sShowPw(true)} title="Cambiar contraseña" style={{width:28,height:28,borderRadius:7,border:"1px solid "+colors.g2,background:cardBg,cursor:"pointer",fontSize:12}}>🔒</button>
            <button aria-label="Cerrar sesión" onClick={out} style={{width:28,height:28,borderRadius:7,border:"1px solid "+colors.g2,background:cardBg,cursor:"pointer",fontSize:12}}>↩</button>
          </div>
        </div>

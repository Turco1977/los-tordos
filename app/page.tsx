...
function Login({users,deptos,onSel}:{users:any[];deptos:any[];onSel:any}){
  ...
  const logo=<><div style={{width:100,height:100,borderRadius:"50%",background:"rgba(255,255,255,.12)",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 18px",border:"3px solid rgba(255,255,255,.25)"}}><span style={{fontSize:50}}>🏉</span></div><h1 style={{color:"#fff",fontSize:30,margin:"0 0 4px",fontWeight:800,letterSpacing:1}}>Los Tordos Rugby Club</h1><p style={{color:"rgba(255,255,255,.6)",fontSize:14,margin:"0 0 32px",fontWeight:500}}>Sistema de Gestión</p></>;
